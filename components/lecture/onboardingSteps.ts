  ...
  teacher: [
    {
      ...
      description: "자료 준비 없이 실제 강의 61장과 퀴즈·실습을 체험할 수 있어요. 내 자료를 사용하는 환경에서는 PPT 제목으로 퀴즈·실습 슬라이드를 찾아 연결합니다.",
      ...
      tip: "공개 데모에서는 샘플을 이용해 주세요. 내 PPT/PDF 업로드는 현재 로컬 실행 환경에서 지원합니다."
    },
    {
      ...
      tip: "PDF에는 발표자 노트가 없어요. 내 자료로 생성하려면 대본이 있는 PPT가 필요합니다. 실습 위치 감지와 AI 퀴즈 생성은 서로 다른 기능이에요."
    },
    {
