  ...
  teacher: [
    ...
    },
    {
      ...
      callouts: [
        ...
        { label: "생성 결과 확인", detail: "슬라이드 아래에 생성된 문제를 확인한 뒤 수업에 활용하세요.", from: [75, 55], to: [62, 65] }
      ],
    ...
    },
    {
      ...
      callouts: [
        { label: "응답 집계", detail: "참여 인원과 선택지별 응답 수가 자동으로 갱신돼요.", from: [65, 40], to: [83, 46] },
        { label: "정답 공개·숨기기", detail: "정답을 공개하면 학생도 정답을 확인해요. 공개 중에는 답 변경이 마감됩니다.", from: [57, 25], to: [74, 29] }
      ],
    ...
    },
    {
      ...
      callouts: [
        ...
        { label: "실습 이어가기", detail: "실습가이드와 결과물을 수업 화면 안에서 열어 확인합니다.", from: [84, 32], to: [87, 12] }
      ],
  ...
  student: [
    ...
    },
    {
      ...
      callouts: [
        ...
        { label: "저장 상태 확인", detail: "‘응답이 저장됐어요’가 나오면 완료! 정답 공개 전까지 답을 바꿀 수 있어요.", from: [59, 82], to: [36, 71] }
      ],
